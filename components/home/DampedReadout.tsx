...
// TEMPORARY (ADR-044) — damped-response readout for the early-visitor notice,
// restored per founder with EXPLANATORY copy (the ADR-040 version had zero
// context; the founder: "shouldn't be zero context").
// It is a REPRESENTATIVE second-order system — not measured/simulated data
// from any real project; the caption says what it is, never claims data.
// Runs only at >=1024px + tab visible + motion allowed; the closed-form
// static curve renders otherwise (server-rendered, so the band is complete
// with JavaScript disabled). Delete with the notice.
...
export function DampedReadout() {
  ...
  return (
    <div className="field">
      <div className="field__cap">Systems thinking, live · x · ẋ</div>
      ...
      <p className="field__note">A damped system rings once, then settles — like this site, and everything else I build.</p>
    </div>
  );
}
